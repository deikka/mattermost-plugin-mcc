...
- [x] **NOTF-01**: Cambios en tareas de Plane (estado, asignacion, comentarios) se publican automaticamente en el canal vinculado via webhooks
- [x] **NOTF-02**: Bot publica resumen periodico (configurable: diario/semanal) del estado del proyecto en el canal vinculado
